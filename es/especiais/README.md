...
![cover](../../.tko/cache/es/base/especiais/cover.jpg)
...
- [solver.cpp](../../.tko/cache/es/base/especiais/.drafts.cpp)
- [solver.java](../../.tko/cache/es/base/especiais/.drafts.java)
- [solver.ts](../../.tko/cache/es/base/especiais/.drafts.ts)
